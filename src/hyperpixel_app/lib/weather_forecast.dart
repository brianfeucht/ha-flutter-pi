...
class WeatherForecast {
  ...
  late RestartableTimer _updateForecastTimer;
  ...
  WeatherForecast(AppLog appLog) : _appLog = appLog {
    _updateForecastTimer = RestartableTimer(
        const Duration(minutes: 30), () => retriveLatestForecast());
  }
